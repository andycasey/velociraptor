...
parameters {
    ...
    real<lower=0.5, upper=15> mu_single[D]; // single star distribution mean
    real<lower=0.05, upper=10> sigma_single[D]; // single star distribution sigma
    real<lower=0.2, upper=1.6> sigma_multiple[D]; // multiplcity log-normal distribution sigma
