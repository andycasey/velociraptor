...
\begin{figure*}
	\includegraphics[width=1.0\textwidth,height=3.0in]{../figures/todo.png}
    \caption{Hertzsprung-Russell diagram of X \Gaia\ sources that are in the
    		 ranges specified in Equation \ref{eq:rvs_parameter_ranges} (gray).
		 	 Overlaid in colour we show the SB2 candidates we deduce by the
			 absence of reported radial velocity.}
    \label{fig:sb2_hrd}
\end{figure*}
