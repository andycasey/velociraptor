...
underpins much of astrophysics. 
%Precisely measuring these quantities is challenging and observationally demanding. 
Here we use \Gaia\ data to detect and partially 
characterise \NumberOfStellarMultiples\ stellar multiple systems based on excess 
jitter in astrometry and radial velocity.
